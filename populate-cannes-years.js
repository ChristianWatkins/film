...
async function scrapeYear(page, year) {
  console.log(`\n🎬 Fetching Cannes ${year} from MUBI...`);
...
async function processFilms(scrapedFilms, year) {
  console.log(`\n📊 Processing ${scrapedFilms.length} films for Cannes ${year}...`);
...
function printSummary(year, results) {
  console.log(`\n${'='.repeat(60)}`);
  console.log(`📊 SUMMARY: Cannes ${year}`);
...
async function main() {
  ...
  console.log('🎬 Cannes Festival Data Population');
  console.log('='.repeat(60));
